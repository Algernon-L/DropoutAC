...
# DATD3 ver1
# DATD3 with random sample weight update [0.5,1,5]
...
class DATD3ver1(object):
	...
	def train(self, replay_buffer, batch_size=256):
		...
		critic1_loss = q1weight * F.mse_loss(current_Q1, target_Q)
		...
		critic2_loss = q2weight * F.mse_loss(current_Q2, target_Q)
